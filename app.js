...
function renderBrand() {
  ...
  if (announcement && brand.announcementText) {
    announcement.textContent = brand.announcementText;
  }
...
function renderProduct() {
  ...
  // Feature options with swatch images
  let optionsHTML = '';
  ...
  document.getElementById('product-info').innerHTML = `
    ...
    <hr class="divider">
    ${optionsHTML}
    <a class="inquire-btn" href="${config.brand.website}">Shop at ${config.brand.name}</a>
    <div class="lead-time">
